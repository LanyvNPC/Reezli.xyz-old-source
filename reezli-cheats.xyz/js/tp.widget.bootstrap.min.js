        ...
        t.exports = function(e) {
            ...
            return e.schemaType && e.location ? (function(e) {
                ...
                var t = e.businessunitId,
                    ...
                    l = e.availability,
                    d = i && i.split("-")[0],
                    c = "https://widget.trustpilot.com" + ("5763bccae0a06d08e809ecbb" === n ? "/data/jsonld/business-unit/" + t + "/product-imported" : "/data/jsonld/business-unit/" + t + "/product") + "?sku=" + encodeURIComponent(o) + "&numberOfReviews=" + (r || 10) + (s ? "&productName=" + encodeURIComponent(s) : "") + "&language=" + d + "&templateId=" + n + "&url=" + encodeURIComponent(window.location.origin + window.location.pathname),
                    h = a && u && l ? {
                        "@type": "Offer",
                        priceCurrency: u,
                        price: a,
